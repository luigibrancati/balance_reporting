...
class DataSource(Enum):
    """This is an enum that distinguishes the different sources."""
    BMED = "BMED",
    FLOWE = "FLOWE",
    BNL = "BNL"
...
class DataManager(ABC):
    ...
    def select_best_date_field(self, date_cols:list[str]) -> str:
    ...
    def transform_data(self, df:pl.DataFrame) -> pl.DataFrame:
        ...
        best_date_col = self.select_best_date_field(
